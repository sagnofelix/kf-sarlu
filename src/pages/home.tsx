...
import "../styles/home-style.css"; // Assurez-vous que le chemin est correct
            ...
            <section id="header" className="hero-section">
                <div className="container">
                    <div className="content">
                        ...
                        <p> Notre entreprise se spécialise dans l'exportation, l'exploration et la vente d'or en Guinée. <br />
                        Obtenez le meilleur prix pour votre or. Évaluation gratuite et paiement immédiat.</p>
                ...
                <div className="container">
                    ...
                    <div className="services-grid">
                        <div className="service-item">
                            ...
                            <p>Évaluation professionnelle de votre or avec des instruments de précision certifiés.</p>
                        </div>
                        <div className="service-item">
                            <FaEuroSign className="icon" />
                            <h3>Meilleurs Prix</h3>
                            <p>Nous vous garantissons les meilleurs prix du marché pour votre or.</p>
                        </div>
                        <div className="service-item">
                            <FaShieldAlt className="icon" />
                            <h3>Sécurité Garantie</h3>
                            <p>Transaction sécurisée et confidentielle dans nos locaux surveillés.</p>
                        </div>
                    </div>
                </div>
            </section>
